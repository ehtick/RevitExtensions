...
public static partial class RibbonExtensions
{
    ...
    extension(RibbonPanel panel)
    {
        ...
        ///     </code>
        /// </example>
        public RibbonPanel SetBackground(string color)
        {
        ...
        ///     </code>
        /// </example>
        public RibbonPanel SetTitleBarBackground(string color)
        {
            var convertedColor = (Color)ColorConverter.ConvertFromString(color);
        ...
        ///     </code>
        /// </example>
        public RibbonPanel SetSlideOutPanelBackground(string color)
        {
            var convertedColor = (Color)ColorConverter.ConvertFromString(color);
        ...
        /// </remarks>
        public IRibbonStackPanel AddStackPanel()
        {
        ...
        /// </exception>
        public PushButton AddPushButton(Type command, string buttonText)
        {
        ...
        /// </exception>
        public PulldownButton AddPullDownButton(string internalName, string buttonText)
        {
        ...
        /// </exception>
        public SplitButton AddSplitButton(string internalName, string buttonText)
        {
        ...
        /// </exception>
        public RadioButtonGroup AddRadioButtonGroup(string internalName)
        {
    ...
    extension(RibbonButton button)
    {
        ...
        /// </example>
        public RibbonButton SetImage(string uri)
        {
        ...
        /// </example>
        public RibbonButton SetLargeImage(string uri)
        {
#if REVIT2024_OR_GREATER
            if (TryGetThemedUri(uri, out var themedIconUri))
            {
    ...
    extension(PushButton button)
    {
        ...
        /// </remarks>
        public PushButton SetAvailabilityController<T>() where T : IExternalCommandAvailability, new()
        {
        ...
        ///     </code>
        /// </example>
        public PushButton AddShortcuts(string representation)
        {
        ...
        ///     </code>
        /// </example>
        public PushButton AddShortcuts(params IEnumerable<string> shortcuts)
        {
