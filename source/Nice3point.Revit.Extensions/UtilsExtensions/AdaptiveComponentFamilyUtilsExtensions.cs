...
public static class AdaptiveComponentFamilyUtilsExtensions
{
    ...
    extension(ElementId elementId)
    {
        ...
        /// <returns>Placement number of the Adaptive Placement Point.</returns>
        /// <exception cref="T:Autodesk.Revit.Exceptions.ArgumentException">
        ///    The ElementId refPointId does not correspond to a valid ReferencePoint.
        ///    -or-
        ///    The Element corresponding to ElementId refPointId does not belong to an Adaptive Family.
        ///    -or-
        ///    The ElementId refPointId does not correspond to an Adaptive Placement Point.
        ...
        /// </exception>
        [Pure]
        public int GetAdaptivePlacementNumber(Document document)
        {
            return AdaptiveComponentFamilyUtils.GetPlacementNumber(document, elementId);
        }
        ...
        /// </exception>
        [Pure]
        public AdaptivePointConstraintType GetAdaptivePointConstraintType(Document document)
        {
            return AdaptiveComponentFamilyUtils.GetPointConstraintType(document, elementId);
        }
        ...
        /// </exception>
        [Pure]
        public AdaptivePointOrientationType GetAdaptivePointOrientationType(Document document)
        {
            return AdaptiveComponentFamilyUtils.GetPointOrientationType(document, elementId);
        }
        ...
        /// </exception>
        [Pure]
        public bool IsAdaptivePlacementPoint(Document document)
        {
            return AdaptiveComponentFamilyUtils.IsAdaptivePlacementPoint(document, elementId);
        }
        ...
        /// </exception>
        [Pure]
        public bool IsAdaptivePoint(Document document)
        {
            return AdaptiveComponentFamilyUtils.IsAdaptivePoint(document, elementId);
        }
        ...
        /// </exception>
        [Pure]
        public bool IsAdaptiveShapeHandlePoint(Document document)
        {
            return AdaptiveComponentFamilyUtils.IsAdaptiveShapeHandlePoint(document, elementId);
        }
        ...
        ///    This operation failed.
        /// </exception>
        public void MakeAdaptivePoint(Document document, AdaptivePointType type)
        {
            AdaptiveComponentFamilyUtils.MakeAdaptivePoint(document, elementId, type);
        }
        ...
        ///    This operation failed.
        /// </exception>
        public void SetAdaptivePlacementNumber(Document document, int placementNumber)
        {
            AdaptiveComponentFamilyUtils.SetPlacementNumber(document, elementId, placementNumber);
        }
        ...
        ///    This operation failed.
        /// </exception>
        public void SetAdaptivePointConstraintType(Document document, AdaptivePointConstraintType constraintType)
        {
            AdaptiveComponentFamilyUtils.SetPointConstraintType(document, elementId, constraintType);
        }
        ...
        ///    This operation failed.
        /// </exception>
        public void SetAdaptivePointOrientationType(Document document, AdaptivePointOrientationType orientationType)
        {
            AdaptiveComponentFamilyUtils.SetPointOrientationType(document, elementId, orientationType);
        }
    }
}